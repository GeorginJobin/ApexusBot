...
public class ChutluV12 extends Robot {
    ...
    */
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
		...
		// “Overshoot” the radar turn so you keep the enemy inside the radar cone
    ...
    */
	private void fireControlSystem(EnemyData enemy) {
        ...
        boolean spinning = detectSpinbot();

		double predictedAngle;
		
		if (spinning) {
		    // Head-on targeting for spinbots
		    predictedAngle = Math.toRadians(getHeading() + enemy.bearing);
		} else {
