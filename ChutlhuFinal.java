...
public class ChutlhuFinal extends Robot {
    ...
    */
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
       ...
       enemies.put(enemyName, enemy);
    	...
    	lastEnemyEnergy = e.getEnergy();  // Update this
	...
	*/
	...
	public void onHitWall(HitWallEvent e) {
    	moveDirection *= -1;  // Add direction reversal
	    back(100);  // Increased from 50
	    turnRight(90 * moveDirection);  // More deliberate turn
	}
